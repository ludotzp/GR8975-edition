...
function doSearch() {
  ...
  for (var item in result) {
    ...
    var searchitem = '<div class="result"><a href="{{ site.baseurl }}'+store[ref].link+'?q='+query+'">'+store[ref].title+'</a><p><a class="tag small" href="#{{'+store[ref].activities+'| slugify }}"><span class="post-tag">'+store[ref].activities+'</span></a></p><p>'+store[ref].excerpt+'</o></div>';
